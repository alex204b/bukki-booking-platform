...
| Document | Description |
|----------|-------------|
| [DEPLOY_NOW.md](docs/deployment/DEPLOY_NOW.md) | **⭐ Quick deployment guide** - Get online in 20 minutes |
...
→ Start here: [docs/deployment/DEPLOY_NOW.md](docs/deployment/DEPLOY_NOW.md)

### "I want to set up local development"
→ Start here: [docs/README.md](docs/README.md)

### "I want to add login protection"
→ Start here: [docs/guides/LOGIN_PROTECTION_IMPLEMENTATION.md](docs/guides/LOGIN_PROTECTION_IMPLEMENTATION.md)

### "I want to understand the codebase"
→ Start here: [docs/development/PROJECT_STRUCTURE.md](docs/development/PROJECT_STRUCTURE.md)

### "I want to add push notifications"
→ Start here: [docs/development/PUSH_NOTIFICATIONS_SETUP.md](docs/development/PUSH_NOTIFICATIONS_SETUP.md)

### "I'm having issues"
→ Start here: [docs/troubleshooting/](docs/troubleshooting/)
...
├── frontend/               # React frontend (web + mobile)
